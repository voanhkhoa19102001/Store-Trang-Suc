...
<div class="top-header">
    ...
    <fieldset>
        ...
        <p>ĐỔI MẬT KHẨU</p>
        <input type="password" id="uname" name="uname" placeholder="Mật khẩu hiện tại" style="width: 70%;margin-left: 15%;">
        <input type="password" id="pass" name="pass" placeholder="Mật khẩu mới" style="width: 70%;margin-left: 15%;">
        <input type="password" id="passconfirm" placeholder="Xác nhận mật khẩu mới" style="width: 70%;margin-left: 15%;">
