...
<body>
    ...
    <button style="background-color:#1499ff;color:white;font-size:1.3rem;border-radius: 0.5rem;margin-left: 10%;display: none;padding:0 1rem 0 1rem;" onclick="displayViewAll()" id="view-all_product">Hiển thị tất cả</button><div class="products">
